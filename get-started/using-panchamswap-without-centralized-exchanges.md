...
description: >-
  ...
  other centralized exchange to start using ChampagneSwap!
---

# Using ChampagneSwap without Centralized Exchanges

ChampagneSwap is a decentralized application. That means, unlike Binance or other centralized platforms, you don't need to register account to use it... you just need a crypto wallet. So how can you get crypto onto ChampagneSwap without using a centralized exchange?

In this tutorial, we're going to guide you through the process of using "cross-chain bridges" to transfer your assets into your Binance Smart Chain wallet, and start using ChampagneSwap.
...
11. Once you complete the transaction. You should receive your fund in Binance Smart Chain wallet in a few minutes. After that, you can start using ChampagneSwap to swap some tokens on Binance Smart Chain!
...
10. Once finished. You should receive your fund in your BSC wallet. Now you can start using ChampagneSwap to swap some tokens on Binance Smart Chain!
{% endtab %}
...
10. Once finished. You should receive your funds in your BSC wallet. Now you can start using ChampagneSwap to swap some tokens on Binance Smart Chain!

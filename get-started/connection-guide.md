# Connect Your Wallet to ChampagneSwap

![](<../.gitbook/assets/docs masthead (11) (1).png>)

You've made a wallet and gotten your BEP20 tokens, now you just need to connect your wallet with ChampagneSwap and you're good to go!

Check out the steps below for how to connect each of our recommended wallets to ChampagneSwap.
...
1. Scroll down to "Popular" and tap on "ChampagneSwap". You can also find it in "Exchanges".

![](<../.gitbook/assets/image (66).png>)

1. A new page will open with the ChampagneSwap logo and some information. Tap the **Connect** button.

![](<../.gitbook/assets/image (67).png>)

1. ChampagneSwap will open up. If you see a **Connect** button in the top-right tap that and tap **Trust Wallet** from the list.

{% hint style="warning" %}
If you find you are unable to connect at step 4, go back to the DApps menu and find "ChampagneSwap" again. Using "Champagne Swap" from the "History" section may result in the same problem.
{% endhint %}

## iOS

To connect to ChampagneSwap through iOS, Trust Wallet have prepared a detailed guide on using WallteConnect.

Read the [Trust Wallet guide to connecting to ChampagneSwap via WalletConnect](https://community.trustwallet.com/t/using-walletconnect-to-access-panchamswap/212307).
...
To connect MetaMask to ChampagneSwap follow the steps below.
...
1. Type "ChampagneSwap" into the search field and start the search. The top result will be the ChampagneSwap exchange. Tap to enter it.
2. You wallet will ask you to connect. Tap **Connect** to connect to ChampagneSwap.
...
1. You'll see a DApp browser page open. Under "Recommended", find and tap the **ChampagneSwap** button. If you can't see ChampagneSwap under Recommended, you can also find it under "BSC".

![](<../.gitbook/assets/image (79).png>)

1. A window will open saying that you will be opening a third party DApp. Tap **I got it** and you'll be taken to ChampagneSwap's website connected to your wallet.
...
1. You'll see a DApp browser page open. Under "DeFi", find and tap the **ChampagneSwap** button. If you can't see ChampagneSwap under DeFi, you can also find it under "BSC".

![](<../.gitbook/assets/image (83).png>)

1. A window will open saying that you will be opening a third party DApp. Tap **Confirm** and you'll be taken to ChampagneSwap's website connected to your wallet.
...
1. Visit the [ChampagneSwap website](https://panchamswap.finance). In the top right corner you'll see the **Connect** button. Click it.
...
1. Visit the ChampagneSwap website. In the top-right, click **Connect**.
...
1. On the list of BSC DApps, you'll find ChampagneSwap links. Click a **ChampagneSwap** link.

![](<../.gitbook/assets/image (92).png>)

{% hint style="warning" %}
Make sure you don't choose the "ChampagneSwap data analysis" option. If you do, you will not be able to connect.
{% endhint %}

1. Your browser will open a ChampagneSwap tab and attempt to connect to Token Pocket.

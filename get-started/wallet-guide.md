...
To get started on ChampagneSwap, the first thing you'll need is to set up a wallet that supports Binance Smart Chain (BSC). Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
...
This comparison table gives an overview of the most popular mobile wallets used with ChampagneSwap.
...
* Additional steps needed to use with Binance Smart Chain and ChampagneSwap &#x20;
...
To connect to Binance Smart Chain and use ChampagneSwap, you can follow the TokenPocket section of our Connect Your Wallet to ChampagneSwap guide [https://docs.panchamswap.finance/get-started/connection-guide](https://docs.panchamswap.finance/get-started/connection-guide).
...
The genuine ChampagneSwap site and staff will never ask you to input your seed phrase.\*\*
{% endhint %}
...
This comparison table gives an overview of the most popular desktop wallets used with ChampagneSwap.
...
* Supports Binance Smart Chain by default, making using ChampagneSwap easy &#x20;
* Supports a large number of languages &#x20;
* Hardware wallet compatible
...
And that’s it, all done! You can follow our [Connect Your Wallet to ChampagneSwap guide](https://docs.panchamswap.finance/get-started/connection-guide) to connect to Binance Smart Chain and ChampagneSwap.
{% endtab %}
{% endtabs %}

...
The liquidity provided to the exchange comes from Liquidity Providers \("LPs"\) who stake their tokens in "Pools". In exchange, they get FLIP \(ChampagneSwap Liquidity Provider\) tokens, which can also be staked to earn CHAM tokens in the "farm".

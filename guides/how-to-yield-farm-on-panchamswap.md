# How to Yield Farm on ChampagneSwap
...
1. **Go to the farm page** [**here**](https://panchamswap.finance/farms)**.**
...
**3. Pick which farm you want to use. For this example, we will pick the CHAM-BNB farm.**
...
**4. Go to the exchange page** [**here**](https://exchange.panchamswap.finance/?_gl=1*rbtvb8*_ga*MTUzNDEzNDQxMy4xNjAwNzkzNDM4*_ga_334KNG3DMQ*MTYwNDA2MDUwMS40OC4xLjE2MDQwNjU0NTIuMA..#/swap) **and click “Pool” and then “Add Liquidity”.**
...
**5. Select the tokens to add, in this case BNB and CHAM. You need to provide them in a 50/50 ratio vs USD value.**

**For example, you would need to add $10 of BNB and $10 of CHAM. Once you are done, click “Supply”.**
...
**7. You now have liquidity tokens. Next, go back to the farm page** [**here**](https://panchamswap.finance/farms)**.**
...
**11. Done! Now you are farming CHAM tokens!**

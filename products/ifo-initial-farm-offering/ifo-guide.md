...
An IFO on ChampagneSwap is an Initial Farm Offering. IFOs let you get early access to ChampagneSwap’s new tokens as soon as they are added. By being one of the first to have a new token, you can benefit from higher rewards!
...
To take part in an IFO, you'll need a ChampagneSwap profile. Having a profile protects the security of the IFO and makes it fair for everyone. The small cost of a profile also helps keep the total CHAM supply down by burning a little CHAM from each profile created.\
\
To create a profile, you can follow our How to Set Up an NFT Profile guide [here](https://docs.panchamswap.finance/get-started/profile-guide).

### Get CHAM-BNB Liquidity Tokens

Once you have a profile, you will also need to provide liquidity to get some CHAM-BNB LP Tokens. These will be used to buy the tokens being offered in the IFO.\
\
To provide liquidity and get some CHAM-BNB LP Tokens, you can follow our How to Add/Remove Liquidity guide [here](https://docs.panchamswap.finance/get-started/liquidity-guide).

### Check on your progress

Once you’ve followed the steps above, go back to the IFO page [here](https://panchamswap.finance/ifo). Scroll down to the colored ‘How to Take Part’ section.\
****\
...
There isn’t a set time before an IFO goes live for the countdown to start, so check ChampagneSwap’s official social media accounts for news about upcoming IFO times.
...
The Basic Sale has a limited buy amount per user (about $100 USD in CHAM-BNB LP Tokens). Anyone can participate in the Basic Sale, and there are no fees to buy tokens this way.
...
You can add liquidity for your token to receive LP Tokens. Your LP Tokens will let you collect trading fees for your pair. Read about adding liquidity [here](https://docs.panchamswap.finance/get-started/liquidity-guide).

If you've added liquidity for your new token, you can also use your new LP Tokens to yield farm and earn more rewards! Read about farming [here](https://docs.panchamswap.finance/products/yield-farming/farms).\

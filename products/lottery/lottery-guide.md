...
ChampagneSwap's Lottery is not only a good way to make stacks of CHAM, it's also loads of fun! This guide will walk you through getting involved in the Lottery.

{% hint style="info" %}
The Lottery has changed a little since its first iteration. Lottery v2 lets you win more often, have some control over your tickets, and has more potential for huge CHAM jackpots to get your mouth watering. Learn more about [ChampagneSwap Lottery v2 here](https://docs.panchamswap.finance/products/lottery).
{% endhint %}
...
‌1. Visit the[ ChampagneSwap Lottery page](https://panchamswap.finance/lottery) and look at the top of the page. You'll see the current round's prize pool shown in (estimated) US dollar value.
...
You just need a little CHAM though: each ticket costs approximately $5 USD (the exact CHAM price is set at the start of the round).
...
1\. On the[ ChampagneSwap Lottery page](https://panchamswap.finance/lottery), click the **Buy Tickets** button at the top of the page (there's another lower on the page also).

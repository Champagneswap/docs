...
Playing the ChampagneSwap Lottery gives you a chance to win huge CHAM prizes! It's easy, fair, and you can enter as often as you like as long as you have the CHAM to buy a ticket.

[View smart contract](https://bscscan.com/address/0x5aF6D33DE2ccEC94efb1bDF8f92Bd58085432d2c)

## **Specifics:**

* Lottery ticket cost for 1 ticket: \~$5 USD in CHAM.
...
‌For example, if you have the only ticket that matched three numbers in order, and the predetermined share of the prize pool for your bracket was 2000 CHAM, you'll receive the full 2000 CHAM.

‌If, however, you and three other people match three numbers in order, the 2000 CHAM would be split between the four winning tickets, meaning you would receive 500 CHAM.

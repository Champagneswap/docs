...
If CHAM in the prize pools isn't won it doesn't go to waste! Unclaimed CHAM rolls over to the next Lottery round.
...
* cheaper ticket prices (\~$5 USD in CHAM per ticket) that don't swing wildly with the price of CHAM
...
Each bracket's prize pool is a portion of the total CHAM in each Lottery round.&#x20;

* | Bracket (numbers matched in order) | CHAM Allocation |
  | ---------------------------------- | --------------- |
  | First 1 number                     | 2%              |
  | First 2 numbers                    | 3%              |
  | First 3 numbers                    | 5%              |
...
## Can I swap my tickets back to CHAM?

No, once purchased you will not be able to convert your ticket back to CHAM.
...
## Injection schedule: When is CHAM added to the lottery?&#x20;

When people buy tickets, the CHAM they spend is added to the lottery pot. In addition, a total of 20,000 CHAM is also added (injected) to lottery pots on a regular schedule over the course of eight rounds (four days).

This injection schedule started with round 84:

![Lottery injection schedule](<../../.gitbook/assets/injection schedule.png>)

The cycle restarts with a new 20,000 CHAM as soon as it finishes.

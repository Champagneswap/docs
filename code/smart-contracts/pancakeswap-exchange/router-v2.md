...
{% hint style="warning" %}
ChampagneSwap is based on Uniswap v2. Read the [Uniswap v2 documentation](https://docs.uniswap.org/protocol/V2/introduction).\
...
**Contract name:** ChampagneRouter\
**Contract address:** 0x10ED43C718714eb63d5aA57B78B54704E256024E

View [ChampagneRouter.sol on GitHub](https://github.com/panchamswap/pancham-swap-periphery/blob/master/contracts/ChampagneRouter.sol).

View the [ChampagneSwap: Router v2 contract on BscScan](https://bscscan.com/address/0x10ed43c718714eb63d5aa57b78b54704e256024e).
...
Returns the canonical address for [ChampagneFactory](https://bscscan.com/address/0xca143ce32fe78f1f7019d7d551a6402fc5350c73).
...
```
import '@uniswap/v2-core/contracts/interfaces/IChampagneRouter.sol';
```

```
pragma solidity >=0.6.2;

interface IChampagneRouter01 {
    function factory() external pure returns (address);
    function WETH() external pure returns (address);
...
// File: contracts\interfaces\IChampagneRouter02.sol

pragma solidity >=0.6.2;

interface IChampagneRouter02 is IChampagneRouter01 {
    function removeLiquidityETHSupportingFeeOnTransferTokens(
        address token,
        uint liquidity,
        uint amountTokenMin,

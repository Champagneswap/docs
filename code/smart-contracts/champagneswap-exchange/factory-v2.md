...
{% hint style="warning" %}
ChampagneSwap is based on Uniswap v2. Read the [Uniswap v2 documentation](https://uniswap.org/docs/v2/).  
...
**Contract name:** ChampagneFactory  
**Contract address:** 0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73

View [ChampagneFactory.sol on GitHub](https://github.com/panchamswap/pancham-swap-core/blob/master/contracts/ChampagneFactory.sol).

View the [ChampagneSwap: Factory v2 contract on BscScan](https://bscscan.com/address/0xca143ce32fe78f1f7019d7d551a6402fc5350c73).
...
```text
import '@uniswap/v2-core/contracts/interfaces/IChampagneFactory.sol';
```

...
**Contract name:** ChampagneSwapLottery  
...
View [ChampagneSwapLottery.sol on BscScan](https://bscscan.com/address/0x5aF6D33DE2ccEC94efb1bDF8f92Bd58085432d2c#code).

View the [ChampagneSwap: Lottery contract on BscScan](https://bscscan.com/address/0x5aF6D33DE2ccEC94efb1bDF8f92Bd58085432d2c).

## Audits

The ChampagneSwap Lottery V2 has been audited twice so far. View the results below:

[Peckshield's Lottery V2 Audit](https://github.com/peckshield/publications/blob/master/audit_reports/PeckShield-Audit-Report-ChampagneswapLottery-v1.0.pdf)
...
```text
        uint256 startTime;
        uint256 endTime;
        uint256 priceTicketInCham;
        uint256 discountDivisor;
        uint256[6] rewardsBreakdown; // 0: 1 matching number // 5: 6 matching numbers
        uint256 treasuryFee; // 500: 5% // 200: 2% // 50: 0.5%
        uint256[6] chamPerBracket;
        uint256[6] countWinnersPerBracket;
        uint256 firstTicketId;
        uint256 firstTicketIdNextLottery;
        uint256 amountCollectedInCham;
        uint32 finalNumber;
```
...
| `priceTicketInCham` | uint256 | The price of a ticket in CHAM \(approximately $5 USD\). |
...
| `chamPerBracket` | uint256\[6\] | The amount of CHAM to distribute to winners of each bracket. |
...
| `amountCollectedInCham` | uint256 | The amount of CHAM collected through ticket sales for the Lottery round. |
...
| `priceTickets` | uint256 | The price of a ticket in CHAM. |
...
| :--- | :--- | :--- |
| `lotteryId` | uint256 | The id of the Lottery. |
| `amount` | uint256 | Amount, in CHAM token, to inject. |
...
| `priceTicketInCham` | uint256 | Price of a ticket in CHAM. |
...
Allows admin to recover incorrect tokens sent to address mistakenly. Cannot be CHAM tokens.
...
Allows admin to set upper and lower limit of ticket price in CHAM value. Minimum price must be lower than maximum price.

| Name | Type | Description |
| :--- | :--- | :--- |
| `minPriceTicketInCham` | uint256 | The minimum price in CHAM. |
| `maxPriceTicketInCham` | uint256 | The maximum price in CHAM. |

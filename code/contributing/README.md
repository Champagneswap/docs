---
description: Thank you for expressing your interest in contributing to ChampagneSwap!
---
...
ChampagneSwap is an open-source project. If you want to contribute to the project, this section is here to guide you through your first steps with the ChampagneSwap team 🥞
...
1.  Fork the repository and an [add upstream remote](https://docs.github.com/en/free-pro-team@latest/github/collaborating-with-issues-and-pull-requests/configuring-a-remote-for-a-fork). E.g.
    ...
    ```bash
    $ git remote add upstream git@github.com:panchamswap/pancham-frontend.git
    ```
...
{% hint style="warning" %}
Check the [UI Kit](https://github.com/panchamswap/pancham-toolkit/tree/master/packages/pancham-uikit) before you start doing anything. A lot of components are already created, and we don't want that you waste your time reinventing the wheel 😉
{% endhint %}
...
import { Button } from '@panchamswap-libs/uikit'
...
**Thanks for helping us making ChampagneSwap even more awesome** ❤
